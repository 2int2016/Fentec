(function(){
	...
	angular.module('fentec').controller('PatrocinadorController', function($scope, $window, $http){
		var 
			$ = jQuery,
			ng = $scope,
			aj = $http,
		...
		$scope.create = function(){
			$http.post('./service/tbpatrocinadores', $scope.model).success(function(data){
				$scope.read();
			});	
		};
		...
		$scope.read = function(){
			try
			{
				aj.get('./service/tbpatrocinadores').success(function(data){
					$scope.arr = data;
				});
			}
			catch(err)
		...
		$scope.delete = function($id){
			aj.delete('./service/tbpatrocinadores/'+$id).success(function(data){
				$scope.read();
			});
		};
		...
		$("#fileUpload").on('change', function(){
			if(typeof (FileReader) != "undefined"){
				...
				image_holder.show();
				$scope.model.caminhoimagem = $(this)[0].files[0].name;
